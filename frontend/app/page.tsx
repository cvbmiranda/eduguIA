...
// ==========================================
  ...
  // ==========================================
  // ==========================================
  // ⭐ TORNEIO DE INTERESSES (EXPANDIDO - 30 DUELOS)
  // ==========================================
  const DUELOS = [
  ...
  useEffect(() => {
    if (intCampeao !== "") {
      ...
      // Redireciona direto sem travar o usuário com um pop-up
      setAbaAtiva("home");
      console.log(`Interesse salvo: ${intCampeao}`); 
    }
  }, [intCampeao]);
  ...
  const handleLogin = async (e: React.FormEvent) => { 
    ...
    try { 
      ...
      if (resMe.ok) { 
        ...
        // 3. AGORA SIM: Força a aba Home por último
        setIsLoggedIn(true); // Só marca como logado aqui
        setAbaAtiva("home");
      }
...
{/* PARKOUR V2 (MOTOR AVANÇADO) */}
      ...
      {abaAtiva === "interesses" && (
        <section className="card">
          ...
          {/* BLOCO DE INSTRUÇÕES (Solicitado no roteiro) */}
          <div style={{ marginBottom: "20px", background: "rgba(59, 130, 246, 0.1)", padding: "15px", borderRadius: "8px", color: "#e2e8f0", fontSize: "14px", borderLeft: "4px solid #3b82f6", textAlign: "left" }}>
            <strong>Como funciona:</strong> Analise as duas opções abaixo e clique na imagem que mais te atrai. Não pense muito, use sua intuição para mapearmos seu perfil!
          </div>
          ...
          <div className="card" style={{ background: "var(--bg2)", border: "1px solid var(--b1)", textAlign: "center", padding: "20px" }}>
            {intCampeao === "" ? (
              <div>
                ...
                {/* CONTAINER DOS CARDS - HORIZONTAL E RESPONSIVO */}
                <div style={{ 
                  display: "flex", 
                  gap: "20px", 
                  ...
                  <button 
                    className="btn" 
                    style={{ flex: "1", minWidth: "280px", maxWidth: "400px", height: "auto", padding: "15px", background: "#0b1222", border: "2px solid #1e3a8a", color: "#fff", cursor: "pointer", borderRadius: "12px", transition: "all 0.2s", display: "flex", flexDirection: "column" }} 
                    onClick={() => handleEscolhaInteresse(DUELOS[intRound].a.p)}
                    onMouseOver={(e) => e.currentTarget.style.borderColor = "#3b82f6"}
                    onMouseOut={(e) => e.currentTarget.style.borderColor = "#1e3a8a"}
                  >
                  ...
                  <button 
                    className="btn" 
                    style={{ flex: "1", minWidth: "280px", maxWidth: "400px", height: "auto", padding: "15px", background: "#0b1222", border: "2px solid #1e3a8a", color: "#fff", cursor: "pointer", borderRadius: "12px", transition: "all 0.2s", display: "flex", flexDirection: "column" }} 
                    onClick={() => handleEscolhaInteresse(DUELOS[intRound].b.p)}
                    onMouseOver={(e) => e.currentTarget.style.borderColor = "#3b82f6"}
                    onMouseOut={(e) => e.currentTarget.style.borderColor = "#1e3a8a"}
                  >
              ...
              <div style={{ animation: "fadeIn 1s ease-in-out", padding: "40px 0" }}>
                ...
                <p className="mut" style={{ marginBottom: "30px", maxWidth: "500px", margin: "0 auto 30px auto" }}>Baseado nas suas escolhas, esta é a área que mais combina com você!</p>
